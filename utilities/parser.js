...
var StartingHeaderVars;
(function (StartingHeaderVars) {
    StartingHeaderVars["Topics"] = "Topics Covered";
    StartingHeaderVars["Synopsis"] = "Synopsis";
    StartingHeaderVars["TableContent"] = "Table of Contents";
    StartingHeaderVars["LearningObj"] = "Learning Objectives";
})(StartingHeaderVars || (StartingHeaderVars = {}));
export default class Parser {
    ...
    */
    getHeadings() {
        ...
        return (_a = filterHeadings(new Map(sections))) !== null && _a !== void 0 ? _a : sections;
    }
    getContent(boundaries) {
